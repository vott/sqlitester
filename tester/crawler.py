...
class SeleniumCrawler(object):
    ...
    def __init__(self, base_url, exclusion_list, output_file='/var/src/app/example.csv', start_url=None):
        display = Display(visible=0, size=(800, 600))
        display.start()
        assert isinstance(exclusion_list, list), 'Exclusion list - needs to be a list'
        self.browser = webdriver.Firefox(log_path='/var/log/geckolog.log')  #Add path to your Firefox.
        self.base = base_url
